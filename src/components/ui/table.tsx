...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-sm bg-card">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t border-foreground/10 bg-foreground/[0.04] font-medium", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ...
    scope="col"
    className={cn(
      "h-10 px-3 text-left align-middle font-medium text-foreground/55 [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
