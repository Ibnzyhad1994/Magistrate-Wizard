...
const sheetVariants = cva(
  "fixed z-dialog gap-4 bg-card p-6 text-foreground shadow-none transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
