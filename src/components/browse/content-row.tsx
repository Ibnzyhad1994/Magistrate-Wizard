    ...
    <section className={cn("group/row relative space-y-3", className)}>
      ...
      <div className="relative">
        <button
          ...
          className={cn(
            "absolute left-0 top-0 z-10 flex h-full w-9 items-center justify-center bg-gradient-to-r from-background to-transparent text-foreground transition-opacity",
            canScrollLeft
        ...
        <button
          ...
          className={cn(
            "absolute right-0 top-0 z-10 flex h-full w-9 items-center justify-center bg-gradient-to-l from-background to-transparent text-foreground transition-opacity",
            canScrollRight
              ? "opacity-100 md:opacity-0 md:group-hover/row:opacity-100"
              : "pointer-events-none opacity-0",
          )}
