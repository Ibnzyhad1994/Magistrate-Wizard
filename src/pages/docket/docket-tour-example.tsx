...
function ExampleCaseLabel() {
  return (
    <div data-tour="docket-first-matter">
      <p className="truncate text-xs font-semibold text-muted-foreground">{EXAMPLE_CASE_NUMBER}</p>
          ...
          <TableBody>
            <TableRow className="hover:bg-transparent">
              ...
              <TableCell className="whitespace-nowrap">
                <span className="whitespace-nowrap rounded-md px-1.5 py-1 text-left text-xs font-medium text-foreground/70 underline decoration-dotted underline-offset-2">
                  + Set date
                </span>
              </TableCell>
            </TableRow>
...
function MobileExampleCard() {
  return (
    <article className="rounded-sm border border-border bg-card p-3" data-tour="docket-board">
      ...
      <div
        className="mt-3 flex items-center justify-between gap-2 border-t border-border pt-2"
        data-tour="docket-outcome"
      >
