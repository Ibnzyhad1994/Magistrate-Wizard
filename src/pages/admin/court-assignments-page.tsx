...
export default function CourtAssignmentsPage() {
  ...
  const availableCourts = (courts ?? []).filter((c) => !current.some((a) => a.court_id === c.id));
              ...
              <CardContent className="space-y-3">
                ...
                {query.trim().length >= 2 &&
                  (searchPending || query.trim() !== debouncedQuery.trim() ? (
                    ...
                    <p className="px-1 py-2 text-sm text-muted-foreground">No matching profiles.</p>
                  ) : (
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <Button
                            ...
                            disabled={
                              ...
                              (rosterAssignOccupied && !assignResolution)
                            }
                          >
                        ...
                        {history.map((a) => (
                          <li key={a.id} className="py-2 text-sm">
                            ...
                            <p className="text-xs text-muted-foreground">
                              ...
                              {a.ended_at ? formatDate(a.ended_at) : ""}
                            </p>
                          </li>
                        ))}
                      </ul>
