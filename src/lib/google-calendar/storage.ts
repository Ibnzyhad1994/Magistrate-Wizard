import { loadDeviceJson, removeDeviceValue, saveDeviceJson } from "@/lib/device-storage";
...
export type GoogleCalendarLocalState = {
  ...
  pkceVerifier?: string;
  /** Random OAuth `state` nonce issued with the PKCE verifier; the callback must echo it. */
  oauthState?: string;
