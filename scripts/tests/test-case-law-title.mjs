...
check("vs connector stays lowercase", formatCaseLawTitle("SMITH vs JONES"), "Smith vs Jones");
...
check("DPP acronym preserved", formatCaseLawTitle("DPP v JOHN DOE"), "DPP v John Doe");

check("R (Rex) acronym preserved", formatCaseLawTitle("R v SMITH"), "R v Smith");
...
check("Mc prefix", formatCaseLawTitle("MCDONALD v THE STATE"), "McDonald v The State");

check("O' prefix", formatCaseLawTitle("O'BRIEN v DPP"), "O'Brien v DPP");
...
check("whitespace collapsed", formatCaseLawTitle("  SMITH   v   JONES  "), "Smith v Jones");
