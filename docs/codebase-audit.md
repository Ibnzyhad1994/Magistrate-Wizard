...
> **Superseded for quality/safety/usability findings by [`docs/system-audit-2026-09-17.md`](system-audit-2026-09-17.md).** This document was a feature-gap audit; most of its items have since landed and its counts (migrations, tests, pages) are stale.
